...
export const langs: Record<string, LangType & LangText & SystemConfig> = {
  ...
  ar: {
    name: "العربية",
    newsFeedPosts: ["منشورات خلاصة الأخبار", "منشورات آخر الأخبار"],
    reelsBlock: ["ريلز ومقاطع الفيديو القصيرة", "ريلز والفيديوهات القصيرة"],
    commentedOn: ["علّق على منشور من", "علق على منشور من", "علّق على"],
    commentedOnFriend: ["علّق.", "علق"],
    peopleKnow: ["أشخاص قد تعرفهم", "الأشخاص الذين قد تعرفهم"],
    friendRequests: ["طلبات الصداقة", "طلبات صداقة"],
    suggested: [
      "مقترح لك",
      "مقترحة لك",
      "المجموعات المقترحة",
    ...
    tagged: ["تمت الإشارة إليه.", "تم وسمه", "تمت الإشارة"],
    answeredQuestion: ["أجاب على هذا السؤال.", "أجاب عن هذا السؤال"],
    containsReels: ["ريلز", "قصص", "Reels"],
    createAPost: ["إنشاء منشور", "أنشئ منشور"],
    games: ["facebook.com/games/", "/instantgames/play/"],

    _ad: "إعلان",
    _reelsBlock: "ريلز",
    _tagged: "تمت الإشارة إلى صديق في منشور",
    _friendRequests: "طلبات الصداقة",
    _containsReels: "ريلز مشترك",
    _commentedOn: "علّق صديق على صفحة لا تتابعها",
    _commentedOnFriend: "علّق صديق على منشور",
    _peopleKnow: "توصيات الأصدقاء",
    _suggested: "اقتراحات",
    _answeredQuestion: "أجاب صديق على سؤال",
    _games: "كانت لعبة",
    ...
    _system: {
      ...
      donate: {
        url: "https://liberapay.com/mohseenjamall/donate",
        imgAlt: "الدعم عبر Liberapay",
        img: "https://liberapay.com/assets/widgets/donate.svg",
      },
      header: {
        msg: "هل هناك مشكلة؟",
        link: "https://github.com/mohseenjamall/FB_Hidden/issues/new",
        linkMsg: "أبلغ عن مشكلة",
      },
      banner: {
        link: "https://github.com/mohseenjamall/FB_Hidden",
        linkMsg: "اعرف المزيد",
        ...
        btn: "الإعدادات",
        colour: "indigo",
        title: "FB Hide - إخفاء التوصيات والريلز",
        desc: "هذه الإضافة تنظف خلاصتك من المحتوى غير ذي الصلة. تم تطويرها بواسطة محسن جمال.",
      },
      bannerHello: {
        link: "https://github.com/mohseenjamall/FB_Hidden",
        linkMsg: "اعرف المزيد",
        ...
        btn: "ابدأ",
        colour: "green",
        title: "مرحباً بك في FB Hide - إخفاء التوصيات والريلز",
        desc: "هيا نبدأ. اضغط على الزر أدناه لضبط إعدادات الإضافة. تم تطويرها بواسطة محسن جمال.",
      },
      bannerHelloUpgrade: {
        link: "https://github.com/mohseenjamall/FB_Hidden",
        linkMsg: "اعرف المزيد",
        ...
        fields: [
          {
            ...
            colour: "green",
            title: "حفظ الإعدادات",
            desc: "هيا نعيدك إلى العمل.",
          },
        ],
      },
      bannerError: {
        linkMsg: "تجاهل/متابعة",
        showLangs: false,
        btn: "إرسال تشخيص للدعم",
        colour: "green",
        title: "نأسف، ولكن حدث خطأ ما.",
        desc: "لم نتمكن من العثور على عناصر الخلاصة في هذه الصفحة.<br />لا يمكن لهذه الإضافة العمل بدون معرفة مكان الخلاصة.<br />الرجاء الضغط على الزر أدناه لإرسال تشخيص للدعم.",
        desc2:
          "عندما ترسل تشخيصاً للدعم، سنلتقط لقطة من HTML في الصفحة لمساعدتنا في تحديد وحل أي مشاكل. سنتخلص من التشخيص بمجرد إصلاح المشكلة أو بعد 30 يوماً، أيهما يأتي أولاً. لن نستخدم أو نشارك أي معلومات في التشخيص لأي أغراض أخرى.<br />بعد إرسال التشخيص، سننشئ مشكلة يمكنك متابعتها إذا كنت مهتماً (Github). بمجرد حل المشكلة وإصدار نسخة جديدة من الإضافة، سيقوم متصفحك بالتحديث تلقائياً وستبدأ الإضافة في العمل.<br />لا تحتاج لإلغاء تثبيت الإضافة بعد إرسال التشخيص. ستبقى غير نشطة حتى يتم إصدار النسخة الجديدة وتحاول العثور على الخلاصة مرة أخرى.",
      },
      form: {
        title: "تكوين FB Hide - إخفاء التوصيات والريلز",
        desc: "قم بتكوين كيفية عمل هذه الإضافة",
        forms: [
          {
            title: "إخفاء الكتل",
            fields: [
              {
                type: "checkbox",
                id: "reels",
                title: "الريلز والفيديوهات القصيرة",
                desc: "كتل الريلز والفيديوهات القصيرة.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                id: "containsReels",
                title: "الريلز المشترك",
                desc: "ريلز مشترك من الأصدقاء.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                id: "suggestions",
                title: "مقترح لك / الاقتراحات",
                desc: "توصيات/اقتراحات الصفحات.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                id: "commentedOn",
                title: "علّق صديق على X من صفحة غير معروفة",
                desc: "تعليقات الأصدقاء على صفحات/منشورات لا تعجبك.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                id: "commentedOnFriend",
                title: "علّق صديق على X",
                desc: "تعليقات الأصدقاء على صفحات/منشورات أخرى.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                id: "tagged",
                title: "تمت الإشارة إلى صديق",
                desc: "تمت الإشارة إلى صديق في منشور/ألبوم.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                id: "answeredQuestion",
                title: "أجاب صديق على سؤال",
                desc: "أجاب صديق على كتلة/منشور سؤال.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                ...
                desc: "'توصيات' الأصدقاء أو الأشخاص الذين قد تعرفهم.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
            ...
            fields: [
              {
                type: "checkbox",
                id: "hideBlocks",
                title: "إخفاء جميع الكتل",
                desc: "بدلاً من إظهار كتلة بما تم إخفاؤه، قم بإخفائه فقط.",
                addedInVersion: "1.25.9",
              },
              {
                type: "checkbox",
                id: "needsDelay",
                title: "تأخير تحميل 5 ثوانٍ",
                desc: "تأخير 5 ثوانٍ بعد تحميل الصفحة قبل تفعيل الإضافة.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                id: "clickToShow",
                title: "اضغط للإظهار/الإخفاء",
                desc: "يمكنك الضغط لإظهار/إخفاء عناصر محددة.",
                addedInVersion: "1.0.0",
              },
              {
                type: "checkbox",
                id: "contentCovers",
                title: "إظهار أغلفة المحتوى",
                desc: "يظهر كتلاً شفافة فوق المحتوى المخفي (عند التمرير) - هذا يوقف سلوك التمرير الغريب. عند التعطيل، يتم إخفاء الكتل",
                addedInVersion: "1.26.47",
              },
            ],
          },
            ...
            fields: [
              {
                ...
                desc: "إرجاع جميع إعدادات التكوين إلى الافتراضية.",
              },
            ],
          },
        ],
